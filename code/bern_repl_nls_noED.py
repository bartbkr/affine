...
pickle_file(collect_lam_0, "../temp_res/collect_lam_0_nls_noED")
pickle_file(collect_lam_1, "../temp_res/collect_lam_1_nls_noED")
...
#Collect results
pickle_file(lam_0_all, "../temp_res/lam_0_all_nls_noED")
pickle_file(lam_1_all, "../temp_res/lam_1_all_nls_noED")
pickle_file(cov_all, "../temp_res/cov_all_nls_noED")
pickle_file(collect_lam_0_ref, "../temp_res/collect_lam_0_ref_nls_noED")
pickle_file(collect_lam_1_ref, "../temp_res/collect_lam_1_ref_nls_noED")
pickle_file(collect_cov_ref, "../temp_res/collect_cov_ref_nls_noED")
