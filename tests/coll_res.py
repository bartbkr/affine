...
dfs = ['one_year_res_orig',
       'two_year_res_orig',
       'three_year_res_orig',
       'five_year_res_orig',
       'one_year_res_fbliss',
       'two_year_res_fbliss',
       'three_year_res_fbliss',
       'five_year_res_fbliss']

#set up data frames to hold results
one_year_res_orig = pa.DataFrame(index=yc_dates)
two_year_res_orig = pa.DataFrame(index=yc_dates)
three_year_res_orig = pa.DataFrame(index=yc_dates)
five_year_res_orig = pa.DataFrame(index=yc_dates)

one_year_res_fbliss = pa.DataFrame(index=yc_dates)
two_year_res_fbliss = pa.DataFrame(index=yc_dates)
three_year_res_fbliss = pa.DataFrame(index=yc_dates)
five_year_res_fbliss = pa.DataFrame(index=yc_dates)
        ...
        for xtol in xtols:
            for ftol in ftols:
                ...
                if source == 'fbliss':
                    ...
                    yc_cols = ['TMYTM_1','TMYTM_2','TMYTM_3','TMYTM_5']
                    ...
                    mod_yc_data_nodp = ycdata.reindex(columns=['trcr_y1', 'trcr_y2',
                                                          'trcr_y3', 'trcr_y5'])
